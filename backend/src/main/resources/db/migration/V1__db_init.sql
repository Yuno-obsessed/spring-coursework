...
ALTER TABLE public.pet_diagnosis
    ADD CONSTRAINT fk_pet_diagnosis_on_pet FOREIGN KEY (pet_id) REFERENCES pet (id);

ALTER TABLE public.pet_analysis
    ADD CONSTRAINT fk_pet_analysis_on_pet FOREIGN KEY (pet_id) REFERENCES pet (id);

ALTER TABLE public.surgery
    ADD CONSTRAINT fk_pet_surgery_on_pet FOREIGN KEY (pet_id) REFERENCES pet (id);